...
(function () {
    ...
    const malle = new Malle({
        ...
        fun: (value, original, event, input) => {
            return new Promise((resolve, reject) => {
                const atributo = original.getAttribute("data-atributo");
                ...
                if (atributo === "email") {
                    ...
                    if (!emailRegex.test(value) && value != "") {
                        const ValorIncorrecto = new CustomEvent(
                            "ValorIncorrecto",
                            {
                                detail: {
                                    mensaje:
                                        "El valor proporcionado no es un email válido.",
                                },
                            }
                        );
                ...
                const DatosCambiados = new CustomEvent("DatosCambiados", {
                    detail: {
    ...
    function updateHorizontlMenu() {
        ...
        if (document.getElementById("horimenu-btn")) {
            ...
            var horiMenuCollapse = document.getElementById(
                "topnav-menu-content"
            );
