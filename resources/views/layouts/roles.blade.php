                        ...
                        <div class="mt-md-0 py-3 px-4 mx-2">
                            ...
                            <div class="d-flex flex-column align-items-center justify-content-center">
                                <lord-icon class="" src="https://cdn.lordicon.com/dgiidarp.json" trigger="hover"
                                    colors="primary:#008bcd,secondary:#454340" style="width:65px;height:65px">
                                </lord-icon>

                                <h3 class="text-black mb-2 fw-bold">0</h3>
                                <h5 class="text-black-50 fw-bold mb-0 text-truncate">Roles
                                </h5>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header justify-content-between d-flex align-items-center">
                <a href="./" class="btn btn-success">Agregar roles</a>
            </div><!-- end card header -->
            <div class="card-body">
