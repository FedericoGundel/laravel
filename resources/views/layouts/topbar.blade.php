        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block language-switch">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr">
                        <img src="{{URL::asset('assets/images/flags/germany.jpg')}}" alt="user-image" class="me-2"
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru">
                        <img src="{{URL::asset('assets/images/flags/russia.jpg')}}" alt="user-image" class="me-2"
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    ...
                    <a class="dropdown-item" href="{{ url('auth-signout-cover') }}"><i
