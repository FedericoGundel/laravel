...
var third_party_assets = {
    css_js: [
        {
            name: "@lordicon",
            assets: ["./node_modules/@lordicon/element/dist/index.js"],
        },
        {
            name: "fullcalendar",
            assets: [
        ...
        {
            name: "malle",
            assets: ["./node_modules/@deltablot/malle/dist/main.js"],
        },
    ],
};
...
mix.combine(
    ...
    folder.dist_assets + "js/pages/pricing.init.js"
);
mix.combine(
    "./node_modules/bootstrap/dist/js/bootstrap.bundle.min.js",
    folder.dist_assets + "libs/bootstrap/bootstrap.bundle.min.js"
);
mix.combine(
    "./node_modules/swiper/swiper-bundle.min.css",
...
mix.combine(
    "./node_modules/jsvectormap/dist/maps/world-merc.js",
    folder.dist_assets + "libs/jsvectormap/maps/world-merc.js"
);
...
mix.combine(
    ...
    folder.dist_assets + "libs/masonry-layout/masonry.pkgd.min.js"
);
mix.combine(
    "./node_modules/rater-js/example/index.js",
    folder.dist_assets + "libs/rater-js/index.js"
);
mix.combine(
    "./node_modules/alertifyjs/build/css/themes/default.min.css",
    folder.dist_assets + "libs/alertifyjs/default.min.css"
);
